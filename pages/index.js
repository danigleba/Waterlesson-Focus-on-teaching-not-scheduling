    ...
    <>
      ...
      <main className={`${inter.className} bg-[#ffffff] text-[#1a100d] overflow-hidden`}>
        ...
        <div className="pt-12 pb-24 bg-[#f9f9f9]">
         ...
         {/*Without Vs. With*/}
         <div className="w-full text-center pt-24 pb-16">
        ...
        {/*Featues*/}
        <div className="w-full text-center h-full px-6 pb-16 pt-24">
        ...
        {/*Pricing*/}
        <div className="flex flex-col items-center justify-center w-full pb-16 mt-24 bg-[#f9f9f9] space-y-24">
          <div className="flex flex-col space-y-6 items-center justify-center md:w-1/2 text-center mt-24 px-6 md:px-8">
        ...
        {/*FAQ*/}
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-start w-full h-full px-6 md:px-24 space-y-12 md:space-y-0 bg-white mt-24 mb-12">
          <div className="w-full">
        ...
        <div className="flex flex-col items-center justify-center space-y-12 w-full px-8 md:px-24 pt-24">
          <p className={`${rubik.className}  font-extrabold text-4xl md:text-6xl text-center`}>Focus on teaching,<br/> not scheduling</p>
